...
public class SA15347two {
    ...
    @Test
    public void IosIos(){
        client.setDevice("ios_app:admins iPad");
        client.sleep(10);
...
//        client.sleep(10);
    ...
    @Test
    public void IosIos2(){
//        client2.setDevice("ios_app:admins iPad");
//        client2.sleep(10);
    }
...
//
    ...
    public void waitForDeviceIosIos(){
        client.waitForDevice("contains(@name,'admin')", 3000);
        client.sleep(10);
...
//
    ...
    public void waitForDeviceAndroidIos(){
        client.waitForDevice("contains(@name,'exus')", 3000);
        client.sleep(10);
        client2.waitForDevice("contains(@name,'admin')", 3000);
        client2.sleep(10);
    }
//
    @Test//3
