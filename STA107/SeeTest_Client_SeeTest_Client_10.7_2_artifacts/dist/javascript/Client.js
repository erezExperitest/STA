var MobileClient = function() {
	  ...
	  function initialize(initHost, initPort, useSessionID) {
			...
			// TODO Find way to set timeout to client to 300000msec
        ...
        function pingServer(callback) {
            return execute("pingclient", [], null, callback);
        }
		...
		function getVersion() { return "10.7"; }
		...
		function configureAPKSigningKeystore(keystorePath, keystorePassword, alias, keyPassword, callback) {
			execute("configureAPKSigningKeystore", [keystorePath, keystorePassword, alias, keyPassword], null, callback);
		}
	...
	return {
		...
		configureAPKSigningKeystore: configureAPKSigningKeystore,
