...
class Client:
    ...
    def getVersion(self): return "10.7"
    ...
    def configureAPKSigningKeystore(self, keystorePath, keystorePassword, alias, keyPassword):
        """Configure a customized keystore to sign Android applications
        Args:
                keystorePath (str): Keystore file location on disk
                keystorePassword (str): Keystore password
                alias (str): Alias
                keyPassword (str): Store password"""
        self.execute("configureAPKSigningKeystore", keystorePath, keystorePassword, alias, keyPassword)
